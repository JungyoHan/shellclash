...
ckstatus(){
	...
	#coreelec systemd
	[ -w /etc/systemd/system -o -w /usr/lib/systemd/system -o -w /storage/.config/system.d ];then
...
localproxy(){
	#coreelec service
	[ -w /etc/systemd/system/clash.service -o -w /usr/lib/systemd/system/clash.service -o -w /storage/.config/system.d/clash.service -o -x /bin/su ] && local_enh=1
...
setboot(){
	...
	2)
		...
		#coreelec systemd
			if [ -f /etc/init.d/clash -o -w /etc/systemd/system -o -w /usr/lib/systemd/system -o -w /storage/.config/system.d ];then
...
case "$1" in
	...
	-u)
		...
		if [ "$res" = '1' ]; then
			...
			#coreelec system
			rm -rf /storage/.config/system/clash.service
			rm -rf /www/clash
			rm -rf /tmp/clash_$USER
